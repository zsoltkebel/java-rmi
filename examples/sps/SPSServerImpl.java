...
public class SPSServerImpl implements SPSServerInterface {
    private Random _gen;
     ...
     * creation time.
     */
    public SPSServerImpl() throws RemoteException {
     ...
     */
    public SPS move(SPS clientChoice) throws RemoteException {
